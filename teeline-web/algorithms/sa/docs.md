...
solver_id: "sa"
title: "Simulated Annealing — Teeline"
description: "Probabilistic local search inspired by metallurgy annealing. Accepts worsening moves with temperature-dependent probability, transitioning from broad exploration to fine-tuned exploitation."
type_badge: "Heuristic · local search (stochastic)"
---
# Simulated Annealing
