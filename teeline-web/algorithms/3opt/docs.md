...
solver_id: "3opt"
title: "3-opt — Teeline"
description: "Extension of 2-opt that removes three edges per iteration and reconnects the three segments in the best of eight possible configurations. Deeper local optima than 2-opt at O(n³) per pass."
