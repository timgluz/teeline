...
_trampoline10.fnName = 'wasi:cli/stdin@0.2.9#getStdin';
...
_trampoline11.fnName = 'wasi:cli/stdout@0.2.9#getStdout';
...
_trampoline12.fnName = 'wasi:cli/stderr@0.2.9#getStderr';
...
_trampoline13.fnName = 'wasi:clocks/monotonic-clock@0.2.9#now';
...
_trampoline14.fnName = 'wasi:clocks/monotonic-clock@0.2.9#subscribeDuration';
let exports1;
let memory0;
let realloc0;
let realloc0Async;
...
_trampoline15.fnName = 'wasi:random/insecure-seed@0.2.9#insecureSeed';
...
_trampoline16.fnName = 'wasi:io/poll@0.2.9#poll';
...
_trampoline17.fnName = 'wasi:io/streams@0.2.9#checkWrite';
...
_trampoline18.fnName = 'wasi:io/streams@0.2.9#write';
...
_trampoline19.fnName = 'wasi:io/streams@0.2.9#blockingFlush';
...
_trampoline20.fnName = 'wasi:cli/environment@0.2.9#getEnvironment';
...
_trampoline21.fnName = 'wasi:cli/terminal-stdin@0.2.9#getTerminalStdin';
...
_trampoline22.fnName = 'wasi:cli/terminal-stdout@0.2.9#getTerminalStdout';
...
_trampoline23.fnName = 'wasi:cli/terminal-stderr@0.2.9#getTerminalStderr';
...
_trampoline24.fnName = 'wasi:clocks/wall-clock@0.2.9#now$1';
let exports2;
let postReturn0;
...
function solve(arg0, arg1, arg2) {
  ...
  var {epochs: v3_0, platooEpochs: v3_1, coolingRate: v3_2, maxTemperature: v3_3, minTemperature: v3_4, mutationProbability: v3_5, nElite: v3_6, nNearest: v3_7, alpha: v3_8, beta: v3_9, evaporationRate: v3_10, numAnts: v3_11 } = arg2;
  ...
  let ret =   _withGlobalCurrentTaskMeta({
    taskID: task.id(),
    componentIdx: task.componentIdx(),
    fn: () => exports1Solve(ptr0, len0, result2, len2, toUint32(v3_0), toUint32(v3_1), +v3_2, +v3_3, +v3_4, +v3_5, toUint32(v3_6), toUint32(v3_7), +v3_8, +v3_9, +v3_10, toUint32(v3_11)),
  });
    ...
    case 0: {
      ...
      variant6= {
        ...
        val: {
          ...
          route: result4,
          durationMs: dataView(memory0).getInt32(ret + 16, true) >>> 0,
        }
      };
      break;
    }
...
function parseAndSolve(arg0, arg1, arg2) {
  ...
  var {epochs: v2_0, platooEpochs: v2_1, coolingRate: v2_2, maxTemperature: v2_3, minTemperature: v2_4, mutationProbability: v2_5, nElite: v2_6, nNearest: v2_7, alpha: v2_8, beta: v2_9, evaporationRate: v2_10, numAnts: v2_11 } = arg2;
  ...
  let ret =   _withGlobalCurrentTaskMeta({
    taskID: task.id(),
    componentIdx: task.componentIdx(),
    fn: () => exports1ParseAndSolve(ptr0, len0, ptr1, len1, toUint32(v2_0), toUint32(v2_1), +v2_2, +v2_3, +v2_4, +v2_5, toUint32(v2_6), toUint32(v2_7), +v2_8, +v2_9, +v2_10, toUint32(v2_11)),
  });
...
function parse(arg0) {
  ...
  _debugLog('[iface="parse", function="parse"][Instruction::CallWasm] enter', {
    funcName: 'parse',
    paramCount: 2,
    async: false,
    postReturn: true,
  ...
  switch (dataView(memory0).getUint8(ret + 0, true)) {
    case 0: {
      ...
      var base4 = dataView(memory0).getUint32(ret + 28, true);
      var result4 = [];
      for (let i = 0; i < len4; i++) {
        const base = base4 + i * 12;
        result4.push({
          id: dataView(memory0).getInt32(base + 0, true) >>> 0,
  ...
  _debugLog('[iface="parse", function="parse"][Instruction::Return]', {
    funcName: 'parse',
    paramCount: 1,
    async: false,
    postReturn: true
...
let exports1ListAlgorithms;

function listAlgorithms() {
  _debugLog('[iface="list-algorithms", function="list-algorithms"][Instruction::CallWasm] enter', {
    funcName: 'list-algorithms',
    paramCount: 0,
    async: false,
    postReturn: true,
  });
  ...
  const [task, _wasm_call_currentTaskID] = createNewCurrentTask({
    ...
    isAsync: false,
    isManualAsync: false,
    entryFnName: 'exports1ListAlgorithms',
    getCallbackFn: () => null,
    callbackFnName: 'null',
    errHandling: 'none',
    callingWasmExport: true,
  ...
  for (let i = 0; i < len13; i++) {
    ...
    var result2 = TEXT_DECODER_UTF8.decode(new Uint8Array(memory0.buffer, ptr2, len2));
    var ptr3 = dataView(memory0).getUint32(base + 24, true);
    var len3 = dataView(memory0).getUint32(base + 28, true);
    var result3 = TEXT_DECODER_UTF8.decode(new Uint8Array(memory0.buffer, ptr3, len3));
    ...
    var base12 = dataView(memory0).getUint32(base + 40, true);
    var result12 = [];
    for (let i = 0; i < len12; i++) {
      const base = base12 + i * 56;
      ...
      switch (dataView(memory0).getUint8(base + 24, true)) {
        ...
        case 1: {
          variant8 = dataView(memory0).getFloat32(base + 28, true);
          break;
        }
        default: {
      ...
      switch (dataView(memory0).getUint8(base + 32, true)) {
        ...
        case 1: {
          variant9 = dataView(memory0).getFloat32(base + 36, true);
          break;
        }
        default: {
          throw new TypeError('invalid variant discriminant for option');
      ...
      switch (dataView(memory0).getUint8(base + 40, true)) {
        ...
        case 1: {
          variant10 = dataView(memory0).getFloat32(base + 44, true);
          break;
        }
        default: {
          throw new TypeError('invalid variant discriminant for option');
  ...
  _debugLog('[iface="list-algorithms", function="list-algorithms"][Instruction::Return]', {
    funcName: 'list-algorithms',
    paramCount: 1,
    async: false,
    postReturn: true
  });
  task.resolve([result13]);
  const retCopy = result13;
...
let exports1GetVersion;

function getVersion() {
  _debugLog('[iface="get-version", function="get-version"][Instruction::CallWasm] enter', {
    funcName: 'get-version',
    paramCount: 0,
    async: false,
    postReturn: true,
  });
  ...
  const [task, _wasm_call_currentTaskID] = createNewCurrentTask({
    ...
    isAsync: false,
    isManualAsync: false,
    entryFnName: 'exports1GetVersion',
    getCallbackFn: () => null,
    callbackFnName: 'null',
    errHandling: 'none',
    callingWasmExport: true,
...
function compare(arg0, arg1, arg2) {
  ...
  var {epochs: v3_0, platooEpochs: v3_1, coolingRate: v3_2, maxTemperature: v3_3, minTemperature: v3_4, mutationProbability: v3_5, nElite: v3_6, nNearest: v3_7, alpha: v3_8, beta: v3_9, evaporationRate: v3_10, numAnts: v3_11 } = arg2;
  _debugLog('[iface="compare", function="compare"][Instruction::CallWasm] enter', {
    funcName: 'compare',
    paramCount: 16,
    async: false,
    postReturn: true,
  ...
  let ret =   _withGlobalCurrentTaskMeta({
    taskID: task.id(),
    componentIdx: task.componentIdx(),
    fn: () => exports1Compare(result1, len1, ptr2, len2, toUint32(v3_0), toUint32(v3_1), +v3_2, +v3_3, +v3_4, +v3_5, toUint32(v3_6), toUint32(v3_7), +v3_8, +v3_9, +v3_10, toUint32(v3_11)),
  });
  
  var len8 = dataView(memory0).getUint32(ret + 4, true);
  var base8 = dataView(memory0).getUint32(ret + 0, true);
  var result8 = [];
  for (let i = 0; i < len8; i++) {
    const base = base8 + i * 28;
    ...
    switch (dataView(memory0).getUint8(base + 8, true)) {
      case 0: {
        ...
        variant7= {
          tag: 'ok',
          val: {
            total: dataView(memory0).getFloat32(base + 12, true),
            route: result5,
            durationMs: dataView(memory0).getInt32(base + 24, true) >>> 0,
          }
        };
        break;
      }
  ...
  _debugLog('[iface="compare", function="compare"][Instruction::Return]', {
    funcName: 'compare',
    paramCount: 1,
    async: false,
    postReturn: true
  });
  task.resolve([result8]);
  const retCopy = result8;
...
let exports1TourDistance;

function tourDistance(arg0, arg1) {
  var val0 = arg0;
  var len0 = val0.length;
  var ptr0 = realloc0(0, 0, 4, len0 * 4);
  ...
  _debugLog('[iface="tour-distance", function="tour-distance"][Instruction::CallWasm] enter', {
    funcName: 'tour-distance',
    paramCount: 4,
    async: false,
    postReturn: true,
  });
  ...
  const [task, _wasm_call_currentTaskID] = createNewCurrentTask({
    ...
    isAsync: false,
    isManualAsync: false,
    entryFnName: 'exports1TourDistance',
    getCallbackFn: () => null,
    callbackFnName: 'null',
    errHandling: 'throw-result-err',
    callingWasmExport: true,
  ...
  let ret =   _withGlobalCurrentTaskMeta({
    taskID: task.id(),
    componentIdx: task.componentIdx(),
    fn: () => exports1TourDistance(ptr0, len0, result2, len2),
  });
  ...
  _debugLog('[iface="tour-distance", function="tour-distance"][Instruction::Return]', {
    funcName: 'tour-distance',
    paramCount: 1,
    async: false,
    postReturn: true
...
null,
{
  ...
  paramLiftFns: [],
  resultLowerFns: [_lowerFlatTuple([[_lowerFlatU64, 16, 8],[_lowerFlatU64, 16, 8],])],
  funcTypeIsAsync: false,
  getCallbackFn: () => null,
  getPostReturnFn: () => null,
  isCancellable: false,
...
const $init = (() => {
  let gen = (function* _initGenerator () {
    ...
    const module1 = base64Compile('');
    const module2 = base64Compile('AGFzbQEAAAABFwRgAX8AYAN/f38AYAJ/fwBgBH9/f38AAkILAAEwAAAAATEAAQABMgACAAEzAAMAATQAAgABNQAAAAE2AAAAATcAAAABOAAAAAE5AAAACCRpbXBvcnRzAXABCgoJEAEAQQALCgABAgMEBQYHCAkALwlwcm9kdWNlcnMBDHByb2Nlc3NlZC1ieQENd2l0LWNvbXBvbmVudAcwLjI0Ni4y');
    ...
    try {
      postReturn1Async = WebAssembly.promising(exports1.cabi_post_parse);
    } catch(err) {
      postReturn1Async = exports1.cabi_post_parse;
    }
    
    postReturn2 = exports1['cabi_post_list-algorithms'];
    
    try {
      postReturn2Async = WebAssembly.promising(exports1['cabi_post_list-algorithms']);
    } catch(err) {
      postReturn2Async = exports1['cabi_post_list-algorithms'];
    }
    
    postReturn3 = exports1['cabi_post_get-version'];
    
    try {
      postReturn3Async = WebAssembly.promising(exports1['cabi_post_get-version']);
    } catch(err) {
      postReturn3Async = exports1['cabi_post_get-version'];
    }
    
    postReturn4 = exports1.cabi_post_compare;
    
    try {
      postReturn4Async = WebAssembly.promising(exports1.cabi_post_compare);
    } catch(err) {
      postReturn4Async = exports1.cabi_post_compare;
    }
    
    postReturn5 = exports1['cabi_post_compare-tours'];
    
    try {
      postReturn5Async = WebAssembly.promising(exports1['cabi_post_compare-tours']);
    } catch(err) {
      postReturn5Async = exports1['cabi_post_compare-tours'];
    }
    ...
    exports1TourDistance = exports1['tour-distance'];
  })();
...
export { compare, compareTours, getVersion, listAlgorithms, parse, parseAndSolve, solve, tourDistance,  }